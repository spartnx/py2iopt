...
fig. 2.5 and fig. 2.6 using both the Ipopt and the L-BFGS-B algorithms.
"""
...
if __name__ == "__main__":
    ...
    tirdv = TwoImpulseRDV(mu=mu, algo=algo, verbosity=1)
    ...
    fig1 = tirdv.plot(plot_optimal=False, time_scale=2*np.pi)
    fig2 = tirdv.plot(plot_optimal=True, time_scale=2*np.pi)
    plt.show()
